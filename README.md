...
* [`src/clj/acnh/`](src/clj/acnh/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/acnh/`](src/cljs/acnh/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/acnh/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/acnh/`](test/cljs/acnh/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `acnh` project root directory
...
in the [`src/clj/acnh/`](src/clj/acnh/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/acnh/config.cljs) defaults to `true` in
